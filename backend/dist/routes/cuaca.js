    ...
    try {
        if (coords) {
            ...
            try {
                ...
                const response3 = await axios_1.default.get(url3);
        ...
        const response = await axios_1.default.get(`https://api.openweathermap.org/data/2.5/weather?q=${kotaStr},ID&appid=${API_KEY}&units=metric&lang=id`);
